...
#Create a line chart with multiple color-coded y-axis variables and save it 
#as a png image
png("plot3.png",  width = 480, height = 480, units = "px");
plot(newpower$event, newpower$Sub_metering_1, type = "n", xlab = "", ylab = "Energy sub metering");
points(newpower$event, newpower$Sub_metering_1, type = "l");
points(newpower$event, newpower$Sub_metering_2, type = "l", col = "red");
points(newpower$event, newpower$Sub_metering_3, type = "l", col = "blue");
